...
const Popup = () => {
    ...
    const handleLogout = () => {
        axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("http://localhost:4500/api/v1/auth/logout").then((response) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("http://localhost:4500/api/v1/auth/me", {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "h-screen" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "flex justify-center items-center py-44" }, user ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { onClick: handleLogout, className: "py-4 px-3 bg-red-500 text-white m-2" }, "Logout"),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                " ", user === null || user === void 0 ? void 0 :
                user.accessToken,
                " "))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { onClick: handleLogin, className: "py-4 px-3 bg-red-500 text-white m-2" }, "Login with Google")))));
};
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_css-loader_dist_runtime_api_js-node_modules_css-loader_dist_runtime_sour-b53f7e","vendors-node_modules_axios_lib_axios_js","src_assets_tailwind_css"], () => (__webpack_require__("./src/popup/index.tsx")))
